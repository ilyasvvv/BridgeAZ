      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-2.5">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            {/* Notifications */}
            <Link to="/notifications" className="relative p-2 hover:bg-grey-100 rounded-full transition-colors">
              ...
              {unreadCount > 0 && (
                <span className="absolute top-1.5 right-1.5 min-h-2 min-w-2 rounded-full bg-red-500 text-[9px] leading-none text-white">
